...
<body>
	...
	<fmt:formatNumber value = "${a}" pattern = "0000000"/><br> <!-- 0002024 -->
	<fmt:formatNumber value = "${a}" pattern = "0000000.00"/><br> <!-- 0002024.00 -->
	2024-06-27 04:10:25
	...
	<fmt:formatDate value = "${e_date}" pattern = "yyyy년 MM월 dd일 HH시 mm분 ss초"/><br>
	<fmt:formatDate value = "${f}" pattern = "yyyy년 MM월 dd일 HH시 mm분 ss초"/><br>
	${result2}
