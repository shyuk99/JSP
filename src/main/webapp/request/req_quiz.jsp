...
<body>
	...
	<!-- form태그는 사용자가 입력한 값을, 서버(프로젝트)에 전송할 때 사용됨 -->
	
	<!-- form안에 input태그는 name속성을 지정하게 되는데, name은 서버에서 찾아쓰는 이름이 됨 -->
	<form action = "req_quiz_ok.jsp" method = "post">
		...
		<!-- checkbox, radio속성은 반드시 name속성을 사용해서, 하나의 그룹으로 묶어 주어야 함 -->
		관심분야:
		...
		자기소개:<br>
		<textarea rows="5" cols="30" name = "introdece"></textarea>
		<br>
